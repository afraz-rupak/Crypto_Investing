...
│                         Crypto_Investing and configuration for tools like black
│
...
│
└── Crypto_Investing   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes Crypto_Investing a Python module
    │
